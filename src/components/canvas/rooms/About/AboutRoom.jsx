...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'SHUBHAM ARORA', subtitle: '< Full Stack Developer | AWS Cloud />' },
    { id: 'journey', position: [0, 0, -55], type: 'journey', title: 'JOURNEY', subtitle: 'Computer Science @ Amity University' },
    { id: 'skills', position: [0, 0, -95], type: 'skills', title: 'SKILLS', subtitle: 'React • Three.js • GSAP • Creative Code' },
];
